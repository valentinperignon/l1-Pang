...
/**
 * Detect collision with any angles with the others functions
 * @param {object balloon} ball - The balloon
 * @param {object *} object - Any object
 * 
...
/**
 * Detect collision between ball and object
 * @param {object balloon} ball - The balloon
 * @param {object *} object - Any object
 * 
 * @returns {boolean} True if there is a collision
...
/**
 * Change the balloon's velocity
 * @param {object balloon} ball 
 */
...
/**
*  Game update 
*  @param {int} delta the time between now and the last update
*/
